// Generated on 2016-10-17 using generator-angular-fullstack 3.3.0
'use strict';
...
module.exports = function (grunt) {
  ...
  grunt.initConfig({
    ...
    ngconstant: {
      options: {
        name: 'adstheticCmsApp.constants',
        ...
        files: {
          '<%= yeoman.client %>/index.html': [
               [
                 ...
                 '<%= yeoman.client %>/assets/js/jquery.js',
                 '<%= yeoman.client %>/assets/js/plugins.js',
                 '<%= yeoman.client %>/assets/js/functions.js'
               ]
            ]
        }
      },
      ...
      css: {
        ...
        files: {
          '<%= yeoman.client %>/index.html': [
            ...
            '<%= yeoman.client %>/assets/css/bootstrap.css',
            '<%= yeoman.client %>/assets/css/style.css',
            '<%= yeoman.client %>/assets/css/dark.css',
            '<%= yeoman.client %>/assets/css/font-icons.css',
            '<%= yeoman.client %>/assets/css/animate.css',
            '<%= yeoman.client %>/assets/css/magnific-popup.css',
            '<%= yeoman.client %>/assets/css/responsive.css'
          ]
        }
      }
    },
